...
export default function Hero() {
  ...
  return (
    <section className="relative w-full overflow-hidden">
      ...
      <div className="absolute inset-x-0 -top-16 md:-top-32 h-[800px] md:h-[1000px] z-0 pointer-events-none flex items-center justify-center opacity-60 md:opacity-30 select-none overflow-hidden scale-110 md:scale-100">
        <div
          className="scene"
          style={{
            WebkitMask:
              "linear-gradient(90deg, transparent, white 10% 90%, transparent)",
