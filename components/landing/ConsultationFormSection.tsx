      ...
      <div className="relative w-full max-w-[900px] bg-white rounded-2xl md:rounded-[24px] shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-300 flex flex-col md:flex-row h-[90vh] md:h-auto md:min-h-[550px] md:max-h-[85vh]">
        ...
        <div className="md:hidden flex overflow-x-auto hide-scrollbar border-b border-gray-100 p-4 bg-gray-50/80 shrink-0">
          {[
            ...
            <div key={s.id} className={`flex items-center gap-2 px-4 py-2 rounded-full whitespace-nowrap transition-colors ${step === s.id ? 'bg-[#2E8B7A] text-white shadow-sm' : step > s.id ? 'bg-[#2E8B7A]/10 text-[#2E8B7A]' : 'text-gray-400'}`}>
              ...
              {step === 1 && (
                <div className="animate-in fade-in slide-in-from-right-8 duration-500 flex flex-col h-full justify-center">
                  ...
                  <p className="text-sm text-gray-500 mb-8 leading-relaxed max-w-sm">
                    Our customized web development projects start at <strong>₹50,000</strong>. Does this initial investment range align with your available budget for the project?
                  </p>
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    >
                      <div className={`w-6 h-6 rounded-full flex items-center justify-center shrink-0 border ${formData.budgetConfirmation === "Yes" ? 'bg-[#2E8B7A] border-[#2E8B7A] text-white' : 'border-gray-300 bg-white text-transparent'}`}>
                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M10 3L4.5 8.5L2 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                      </div>
                      <span className={`font-semibold text-sm ${formData.budgetConfirmation === "Yes" ? 'text-[#2E8B7A]' : 'text-gray-700'}`}>
                    ...
                    >
                      <div className={`w-6 h-6 rounded-full flex items-center justify-center shrink-0 border ${formData.budgetConfirmation === "No" ? 'bg-red-400 border-red-400 text-white' : 'border-gray-300 bg-white text-transparent'}`}>
                         <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M9 3L3 9M3 3L9 9" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                      </div>
                      <span className={`font-semibold text-sm ${formData.budgetConfirmation === "No" ? 'text-red-600' : 'text-gray-700'}`}>
                ...
                <div className="animate-in fade-in slide-in-from-right-8 duration-500 flex flex-col h-full justify-center space-y-8">
                    ...
                    <div className="space-y-6">
                      <div className="grid grid-cols-2 gap-4">
                          ...
                          <div className="space-y-1.5 col-span-2 sm:col-span-1">
                            <label className="text-xs text-gray-500 font-medium">Email Address <span className="text-red-400">*</span></label>
                            <input
                              required
                              type="email"
                      ...
                      <div className="grid grid-cols-2 gap-4">
                         ...
                         <div className="space-y-1.5 col-span-2 sm:col-span-1">
                           <label className="text-xs text-gray-500 font-medium">Brand / Business Name</label>
                           <input
                             required
                             type="text"
