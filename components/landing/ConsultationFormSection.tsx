          ...
          <div className="flex-1 overflow-y-auto p-6 sm:p-8 md:p-12 hide-scrollbar">
              {isSubmitted ? (
                <div className="animate-in fade-in zoom-in-95 duration-500 flex flex-col items-center justify-center h-full text-center py-12">
                  ...
                  <h3 className="text-3xl font-bold text-[#1A2E22] mb-4">
                    Inquiry Received!
                  </h3>
                  <p className="text-[#1A2E22]/60 max-w-sm mb-8">
                    Thank you for reaching out. Our team will review your details
                    and get back to you within 24 hours.
                  </p>
                  <button
                    onClick={closeModal}
                    className="bg-[#1A2E22] text-white px-8 py-3 rounded-full text-sm font-semibold hover:bg-black transition-colors"
                  >
                    Close Window
                  </button>
                </div>
                ...
                >
                  ...
                  {error && (
                    <p className="mt-4 text-xs font-medium text-red-500 text-center">
                      {error}
                    </p>
                  )}
                  ...
                  <div className="mt-auto pt-8 flex items-center justify-between border-t border-gray-100 mt-12 bg-white sticky bottom-0 z-20 pb-4">
                    {step > 1 ? (
                      <button
                        ...
                        className="text-sm font-semibold text-gray-500 hover:text-gray-800 transition-colors bg-white px-4 py-2 -ml-4 disabled:opacity-50"
                      >
                        Back
                      </button>
                    ) : (
                    ...
                    {step < 3 ? (
                      ...
                      <button
                        type="submit"
                        disabled={isSubmitting}
                        className="bg-[#1A2E22] hover:bg-black text-white px-8 py-2.5 rounded-full text-sm font-medium transition-colors shadow-sm ml-auto flex items-center gap-2"
                      >
                        {isSubmitting ? (
                          <>
